// /projects temporarily disabled; returning 404 via notFound()
import { notFound } from 'next/navigation'
import { genPageMetadata } from 'app/seo'

export const metadata = genPageMetadata({ title: 'Projects (Disabled)' })

export default function ProjectsDisabled() {
  return notFound()
}
