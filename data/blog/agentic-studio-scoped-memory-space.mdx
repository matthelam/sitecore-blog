...
I run my own Legal Framework in that space, which I [wrote up in the last post](/blog/implementing-the-legal-framework). Constitution for the values and the supreme laws, Legislation per area, Common Law for the accumulated facts.
