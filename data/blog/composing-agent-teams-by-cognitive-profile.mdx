...
This isn't a new idea. Deloitte's [Business Chemistry](https://www2.deloitte.com/us/en/pages/operations/articles/business-chemistry.html) framework classifies people into four working styles: Pioneer (possibility-oriented, big-picture), Guardian (stability-oriented, detail-driven), Driver (challenge-oriented, results-focused), and Integrator (connection-oriented, consensus-building).
