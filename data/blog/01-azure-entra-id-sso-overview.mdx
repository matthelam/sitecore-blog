...
- Sitecore Developers should **not create or modify Azure resources directly** unless delegated.  
...
This quick start inventory ensures you begin with all required identifiers, groups, and URLs at hand — letting you focus on configuration and testing rather than hunting down values.
